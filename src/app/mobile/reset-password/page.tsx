...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSuccess(true)
    setTimeout(() => router.push('/mobile/login'), 2000)
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950">
      <div className="bg-gray-900 rounded-2xl shadow-2xl p-8 w-full max-w-sm border border-gray-800">
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-green-500/10 border border-green-500/30 rounded-2xl flex items-center justify-center mx-auto mb-3">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-11 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-green-500"
